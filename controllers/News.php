...
class News extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $pageCount = floor(count($lastNews) / $count);
        return $this->render('index', ['lastNews' => $lastNews, 'pageCount' => $pageCount, 'page' => $page, 'count' => $count], [
            'PageTitle' => $title,
            'MainTitle' => $title,
        ]);
    }
    ...
    public function actionView()
    {
        ...
        if (empty($_POST))
            $lastComments = $this->newsModel->GetLastComments($id);
        $title = $news['title'];
        $pageCount = floor(count($lastComments) / $count);
        return $this->render('view', ['model' => $news, 'lastComments' => $lastComments, 'counter' => $counter,
            'pageCount' => $pageCount, 'page' => $page, 'count' => $count], [
            'PageTitle' => $title,
            'MainTitle' => $title,
        ]);
    }
    ...
    function actionDeleteComment()
    {
        ...
        return $this->render('deletecomment', ['model' => $comment], [
            'PageTitle' => $title,
            'MainTitle' => $title,
        ]);
    }
